...
const QuotationTable = ({ quotationInfo, isAdmin }: QuotationTableProps) => {
  return (
    <div className="flex w-full flex-col mt-5">
      <QuotationOrderTable quotationInfo={quotationInfo} isAdmin={isAdmin} />
      {isAdmin && (
