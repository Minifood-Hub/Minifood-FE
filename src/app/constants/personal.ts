export const PERSONAL_TITLE = '개인정보처리방침';

export const PERSONAL_TEXT = `주)○○○ 개인정보처리방침
(주)미니푸드 (이하 "회사"는) 「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
...
(2) 회사는 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
 ...
 제공받는 제3자명	 제공 목적	 제공하는 개인정보 항목	 제공받는 자의 보유 및 이용 기간
 [제공받는 제3자명]	 [제공 목적]	 [제공하는 개인정보 항목]	 [제공받는 자의 보유 및 이용 기간]
...
이 개인정보처리방침은 OOOO년 OO월 OO일부터 적용됩니다.`;
